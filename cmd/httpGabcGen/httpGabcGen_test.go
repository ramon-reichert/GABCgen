...
func TestGeneratePreface(t *testing.T) {
	...
	*/
	...
	t.Run("generates preface Páscoa I without errors", func(t *testing.T) {
		...
		expectedJSONresponse := `{"dialogue":` + solemnDialogue + `,"text":` + expectedGabcText + `,"gabc":` + expectedComposedGabcFields + `}`
	...
	t.Run("generates preface Páscoa I with Regional dialogue, without errors", func(t *testing.T) {
		...
		expectedJSONresponse := `{"dialogue":` + regionalDialogue + `,"text":` + expectedGabcText + `,"gabc":` + expectedComposedGabcFields + `}`
